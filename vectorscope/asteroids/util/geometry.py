    ...
    if p is not None:                
        ...
        for point in p:                 
            try:    
                ...
                # Sometimes the value in a point is too large for Rect class.
...
if __name__ == "__main__":
    # Self-test for geometry helpers.
    p1 = (1, 5)
    p2 = (4, 7)
    p3 = (4, 5)
    p4 = (3, 7)
    ...
    assert calculateIntersectPoint(p1, p2, p3, p4) is not None
    assert calculateIntersectPoint(p3, p4, p1, p2) is not None
    assert calculateIntersectPoint(p1, p2, p5, p6) is None
    assert calculateIntersectPoint(p3, p4, p5, p6) is None
    assert calculateIntersectPoint(p1, p2, p7, p8) is not None
    assert calculateIntersectPoint(p7, p8, p1, p2) is not None
    assert calculateIntersectPoint(p1, p2, p9, p10) is not None
    assert calculateIntersectPoint(p9, p10, p1, p2) is not None
    assert calculateIntersectPoint(p7, p8, p9, p10) is not None
    assert calculateIntersectPoint(p9, p10, p7, p8) is not None

    print("SUCCESS! All asserts passed for doLinesIntersect")
